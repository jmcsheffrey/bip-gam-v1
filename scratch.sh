# create classrooms
#python ./gam/gam.py create course alias 9901-01-fy17 teacher mmentor@sscps.org name "American Lit - Block A (Mary)" status ACTIVE
python ./gam/gam.py create course alias 9902-01-fy17 teacher ttutor@sscps.org name "AP Lit - Block B (Tim)" status ACTIVE
python ./gam/gam.py create course alias 9903-01-fy17 teacher llecturer@sscps.org name "AP Lang Comp - Block C (Lennie)" status ACTIVE
python ./gam/gam.py create course alias 9904-01-fy17 teacher eexpert@sscps.org name "British Lit - Block E (Ed)" status ACTIVE
python ./gam/gam.py create course alias 9905-01-fy17 teacher mmentor@sscps.org name "English 10 - Block C (Mary)" status ACTIVE
python ./gam/gam.py create course alias 9906-01-fy17 teacher ttutor@sscps.org name "English 10H - Block D (Tim)" status ACTIVE
python ./gam/gam.py create course alias 9907-01-fy17 teacher llecturer@sscps.org name "Intro CompH - Block B (Lennie)" status ACTIVE
python ./gam/gam.py create course alias 9908-01-fy17 teacher eexpert@sscps.org name "Intro Comp - Block E (Ed)" status ACTIVE
python ./gam/gam.py create course alias 9909-01-fy17 teacher hhomeroom@sscps.org name "Statistics - Block C (Harry)" status ACTIVE
python ./gam/gam.py create course alias 9911-01-fy17 teacher ttutor@sscps.org name "ELA7 - Block A (Tim)" status ACTIVE
python ./gam/gam.py create course alias 9911-02-fy17 teacher ttutor@sscps.org name "ELA7 - Block E (Tim)" status ACTIVE
python ./gam/gam.py create course alias 9912-01-fy17 teacher eexpert@sscps.org name "ELA8 - Block D (Ed)" status ACTIVE
python ./gam/gam.py create course alias 9912-02-fy17 teacher eexpert@sscps.org name "ELA8 - Block D (Ed)" status ACTIVE
python ./gam/gam.py create course alias 9921-01-fy17 teacher hhomeroom@sscps.org name "Technology Solutions - Workshop (Harry)" status ACTIVE
python ./gam/gam.py create course alias 9922-01-fy17 teacher sscholar@sscps.org name "Theater Workshop - Block C (Susan)" status ACTIVE
python ./gam/gam.py create course alias 9931-01-fy17 teacher sscholar@sscps.org name "ELA5 - JCJ (Susan)" status ACTIVE
python ./gam/gam.py create course alias 9931-02-fy17 teacher mmentor@sscps.org name "ELA5 - BD (Mary)" status ACTIVE
