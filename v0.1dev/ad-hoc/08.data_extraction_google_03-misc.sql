...
--        remove & add owner statements to each page.
-- ****************************************************
select '../bin/gam/gam update group parents@sscps.org remove group parents@sscps.org' as '# update parents_<levels>@sscps.org'
union
select '../bin/gam/gam update group parents@sscps.org add owner asavage@sscps.org' as '# update parents_<levels>@sscps.org'
union
select '../bin/gam/gam update group parents@sscps.org add owner mtondorf@sscps.org' as '# update parents_<levels>@sscps.org'
union
select concat(
      '../bin/gam/gam update'
...
-- ****************************************************
-- clean up level1
select '../bin/gam/gam update group parents_level1@sscps.org remove group parents@sscps.org' as '# update parents_<levels>@sscps.org'
union
...
-- clean up level2
union
select '../bin/gam/gam update group parents_level2@sscps.org remove group parents@sscps.org' as '# update parents_<levels>@sscps.org'
union
...
-- clean up level3
union
select '../bin/gam/gam update group parents_level3@sscps.org remove group parents@sscps.org' as '# update parents_<levels>@sscps.org'
union
...
-- clean up level4
union
select '../bin/gam/gam update group parents_level4@sscps.org remove group parents@sscps.org' as '# update parents_<levels>@sscps.org'
union
...
-- clean up highschool
union
select '../bin/gam/gam update group parents_highschool@sscps.org remove group parents@sscps.org' as '# update parents_<levels>@sscps.org'
union
