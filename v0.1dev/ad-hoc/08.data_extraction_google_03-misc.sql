...
select concat(
      ...
      , ' add member ', import.CONTACT_HOME_EMAIL
    ) as '# update parents_level1@sscps.org'
  from import_contacts as import
  inner join users on import.APID = users.current_year_id and users.status = 'ACTIVE'
...
select concat(
      ...
      , ' add member ', import.CONTACT_HOME_EMAIL
    ) as '# update parents_level2@sscps.org'
  from import_contacts as import
  inner join users on import.APID = users.current_year_id and users.status = 'ACTIVE'
...
select concat(
      ...
      , ' add member ', import.CONTACT_HOME_EMAIL
    ) as '# update parents_level3@sscps.org'
  from import_contacts as import
  inner join users on import.APID = users.current_year_id and users.status = 'ACTIVE'
...
select concat(
      ...
      , ' add member ', import.CONTACT_HOME_EMAIL
    ) as '# update parents_level4@sscps.org'
  from import_contacts as import
  inner join users on import.APID = users.current_year_id and users.status = 'ACTIVE'
...
select concat(
      ...
      , ' add member ', import.CONTACT_HOME_EMAIL
    ) as '# update parents_highschool@sscps.org'
  from import_contacts as import
  inner join users on import.APID = users.current_year_id and users.status = 'ACTIVE'
